...
# DEBUG = False when canceling auth via the social network, it will return to the /auth/login
...
SOCIAL_AUTH_VK_OAUTH2_KEY = vk_auth["application_id"]
SOCIAL_AUTH_VK_OAUTH2_SECRET = vk_auth["protected_key"]
...
SOCIAL_AUTH_FACEBOOK_KEY = facebook_auth["application_id"]  # ID приложения
SOCIAL_AUTH_FACEBOOK_SECRET = facebook_auth[
    "application_secret"
]  # Секрет приложения
